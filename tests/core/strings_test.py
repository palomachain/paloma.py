...
def test_validates_acc_address():
    assert not is_acc_address("palomavaloper1pdx498r0hrc2fj36sjhs8vuhrz9hd2cw0yhqtk")
    ...
    assert is_acc_address("paloma1pdx498r0hrc2fj36sjhs8vuhrz9hd2cw0tmam9")


def test_convert_to_acc_address():
    assert (
        to_acc_address("palomavaloper1pdx498r0hrc2fj36sjhs8vuhrz9hd2cw0yhqtk")
        == "paloma1pdx498r0hrc2fj36sjhs8vuhrz9hd2cw0tmam9"
    )


def test_validates_val_address():
    assert not is_val_address("paloma1pdx498r0hrc2fj36sjhs8vuhrz9hd2cw0tmam9")
    assert not is_val_address(
        "palomavaloper1pdx498r0hrc2fj36sjhs8vuhrz9hd2cw0ygqtk"
    )  # bad checksum
    assert is_val_address("palomavaloper1pdx498r0hrc2fj36sjhs8vuhrz9hd2cw0yhqtk")


def test_convert_to_val_address():
    assert (
        to_val_address("paloma1pdx498r0hrc2fj36sjhs8vuhrz9hd2cw0tmam9")
